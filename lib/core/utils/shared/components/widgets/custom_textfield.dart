    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        enabledBorder: OutlineInputBorder(
          borderSide:
              const BorderSide(color: AppColor.txtColorMain, width: 0.8),
    ...
    return SizedBox(
      ...
      child: TextFormField(
        ...
        maxLines: obscureText
            ? 1
            : null, // Single line if obscureText is true, else multi-line
        minLines: 1,
        decoration: InputDecoration(
          prefixIcon: prefixIcon != null ? Icon(prefixIcon) : null,
          suffixIcon: suffixIcon,
          ...
          contentPadding:
              const EdgeInsets.fromLTRB(5, 0, 0, 5), // Add content padding back
          filled: true,
          fillColor: Colors.white,
          hintText: hintText,
          enabledBorder: OutlineInputBorder(
