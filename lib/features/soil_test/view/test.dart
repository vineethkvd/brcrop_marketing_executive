...
class _SoilTestListScreenState extends State<SoilTestListScreen> {
  final SoilTestListController soilTestListController = Get.put(SoilTestListController());
  @override
  void initState() {
        ...
        child: Scaffold(
          ...
          body: Container(
            ...
            child: Column(
              ...
              children: [
                Obx(() {
                  if (soilTestListController.soilListModel.value.soillist!.isEmpty) {
                    return Expanded(
                      child: Center(
                    ...
                    return Expanded(
                      child: Padding(
                        ...
                        child: ListView.builder(
                          itemCount: soilTestListController.soilListModel.value.soillist!.length,
                          itemBuilder: (context, index) {
                            final testList =soilTestListController.soilListModel.value.soillist![index];
                            return Padding(
                                  ...
                                  trailing: CustomElevatedBtn(
                                    onPressed: () {
                                      if (testList.result!.isEmpty) {
                                        print('Result is pending ${testList.result!}');
                                        Get.to(
                                              () => const TestResultScreen(),
                                          arguments: testList,
                                        );
                                      } else {
                                        Get.to(ViewPdfScreen(url:"https://baruchgera.com/${testList.result}"));
                                      }
                                    },
                                    child: Text(
